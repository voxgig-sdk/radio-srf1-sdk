# RadioSrf1 SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RadioSrf1SDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RadioSrf1SDK(...) and RadioSrf1SDK.test(...) become
#      RadioSrf1SDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "radiosrf1_sdk"
_SDK_CLASS = "RadioSrf1SDK"
