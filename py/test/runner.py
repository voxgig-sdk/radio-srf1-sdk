...
class RadioSrf1TestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = RadioSrf1TestRunner.getenv("RADIOSRF1_TEST_LIVE")
        override = RadioSrf1TestRunner.getenv("RADIOSRF1_TEST_OVERRIDE")
        ...
        explain = RadioSrf1TestRunner.getenv("RADIOSRF1_TEST_EXPLAIN")
