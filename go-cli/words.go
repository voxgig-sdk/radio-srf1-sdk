...
func registerSDKWords(r *eng.Registry, client *sdk.RadioSrf1SDK) {
...
func runOp(client *sdk.RadioSrf1SDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
