...
func registerTools(server *mcp.Server, client *sdk.RadioSrf1SDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "radio-srf1_list",
		Description: "List records from RadioSrf1. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "radio-srf1_load",
		Description: "Load a single record from RadioSrf1. " +
...
func runOp(client *sdk.RadioSrf1SDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.RadioSrf1SDK, name string) (sdk.RadioSrf1Entity, error) {
