...
The Lua SDK for the RadioSrf1 API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/radio-srf1-sdk/releases)),
...
```
lua/
├── radio-srf1_sdk.lua    -- Main SDK module
...
The main module (`radio-srf1_sdk`) exports the SDK constructor
