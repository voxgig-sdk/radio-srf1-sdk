...
class RadioSrf1CacheFeature extends RadioSrf1BaseFeature
{
    ...
    private function _through(RadioSrf1Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
