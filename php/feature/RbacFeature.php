...
class RadioSrf1RbacFeature extends RadioSrf1BaseFeature
{
    ...
    private function _required(RadioSrf1Context $ctx): ?string
    {
    ...
    private function _reject(RadioSrf1Context $ctx, string $required): void
    {
    ...
    private function _track(RadioSrf1Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
