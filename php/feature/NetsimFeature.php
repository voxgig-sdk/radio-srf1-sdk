...
class RadioSrf1NetsimFeature extends RadioSrf1BaseFeature
{
    ...
    private function _simulate(RadioSrf1Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RadioSrf1Context $ctx, array $applied): void
    {
        $client = $this->client;
