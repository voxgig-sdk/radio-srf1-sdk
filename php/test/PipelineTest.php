...
require_once __DIR__ . '/../radiosrf1_sdk.php';
...
{
    private static function utility(): RadioSrf1Utility
    {
        return new RadioSrf1Utility();
    }
    ...
    private static function ctx(array $over = []): RadioSrf1Context
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new RadioSrf1Context([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new RadioSrf1Operation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof RadioSrf1Error) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new RadioSrf1Operation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = RadioSrf1MakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new RadioSrf1Operation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = RadioSrf1MakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new RadioSrf1Operation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = RadioSrf1MakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RadioSrf1Spec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = RadioSrf1MakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new RadioSrf1Response([]),
            'result' => new RadioSrf1Result([]),
        ]);
        [, $err] = RadioSrf1MakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new RadioSrf1Spec([]),
            'response' => null,
            'result' => new RadioSrf1Result([]),
        ]);
        [, $err] = RadioSrf1MakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new RadioSrf1Spec(['step' => 's']),
            'response' => new RadioSrf1Response(self::resp(404, null, ['x-a' => '1'])),
            'result' => new RadioSrf1Result([]),
        ]);
        [, $err] = RadioSrf1MakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new RadioSrf1Spec(['step' => 's']),
            'response' => new RadioSrf1Response(self::resp(200, ['v' => 1])),
            'result' => new RadioSrf1Result([]),
        ]);
        [, $err] = RadioSrf1MakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new RadioSrf1Spec(['step' => 's']),
            'response' => new RadioSrf1Response(self::resp(200, ['v' => 2])),
            'result' => new RadioSrf1Result([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        RadioSrf1MakeResponse::call($ctx);
    ...
    {
        $preset = new RadioSrf1Response(self::resp(299));
        $ctx = self::ctx([
            'spec' => new RadioSrf1Spec([]),
            'response' => new RadioSrf1Response([]),
            'result' => new RadioSrf1Result([]),
        ...
        [$got, $err] = RadioSrf1MakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new RadioSrf1Result([])]);
        [, $err] = RadioSrf1MakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new RadioSrf1Spec([]), 'result' => null]);
        [, $err] = RadioSrf1MakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RadioSrf1Spec(['step' => 's']),
            'result' => new RadioSrf1Result(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new RadioSrf1Operation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RadioSrf1MakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RadioSrf1Spec(['step' => 's']),
            'result' => new RadioSrf1Result(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new RadioSrf1Operation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RadioSrf1MakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RadioSrf1Result(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new RadioSrf1Spec([]),
            'result' => new RadioSrf1Result([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = RadioSrf1MakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RadioSrf1MakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new RadioSrf1Error('boom', 'boom');
        $utility->fetcher = function (RadioSrf1Context $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RadioSrf1Spec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = RadioSrf1MakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (RadioSrf1Context $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = RadioSrf1MakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(RadioSrf1Response::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (RadioSrf1Context $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RadioSrf1Spec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = RadioSrf1MakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new RadioSrf1Response(self::resp(201));
        $ctx = self::ctx(['spec' => new RadioSrf1Spec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = RadioSrf1MakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = RadioSrf1MakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = RadioSrf1MakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new RadioSrf1Result(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, RadioSrf1Done::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new RadioSrf1Result(['ok' => false])]);
        $this->expectException(RadioSrf1Error::class);
        RadioSrf1Done::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new RadioSrf1Result(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', RadioSrf1MakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        RadioSrf1MakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new RadioSrf1BaseFeature();
        $b = new RadioSrf1BaseFeature();
        RadioSrf1FeatureAdd::call($ctx, $a);
        RadioSrf1FeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): RadioSrf1BaseFeature
    {
        $f = new RadioSrf1BaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        RadioSrf1FeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): RadioSrf1Context
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new RadioSrf1Spec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RadioSrf1PrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new RadioSrf1Response(['headers' => null]),
            'result' => new RadioSrf1Result([]),
        ]);
        RadioSrf1ResultHeaders::call($ctx);
