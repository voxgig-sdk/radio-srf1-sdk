...
// RadioSrf1 SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RadioSrf1SDK::test)
...
{
    private const SDK_CLASS = 'RadioSrf1SDK';
    ...
    private const SDK_BASE = 'radiosrf1_sdk';
