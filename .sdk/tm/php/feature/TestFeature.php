...
// RadioSrf1 SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class RadioSrf1TestFeature extends RadioSrf1BaseFeature
{
    ...
    public function init(RadioSrf1Context $ctx, array $options): void
    {
        ...
        $test_fetcher = function (RadioSrf1Context $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = RadioSrf1Param::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (RadioSrf1Context $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(RadioSrf1Context $ctx, $op, $args): array
    {
