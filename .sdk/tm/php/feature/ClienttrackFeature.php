...
// RadioSrf1 SDK clienttrack feature
...
class RadioSrf1ClienttrackFeature extends RadioSrf1BaseFeature
{
    ...
    public function PostConstruct(RadioSrf1Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'RadioSrf1-SDK';
