...
class RadioSrf1TimeoutFeature extends RadioSrf1BaseFeature
{
    ...
    private function _with_timeout(RadioSrf1Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RadioSrf1Context $_ctx, float $ms): void
    {
        $client = $this->client;
