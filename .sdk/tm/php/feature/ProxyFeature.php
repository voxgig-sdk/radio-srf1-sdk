...
class RadioSrf1ProxyFeature extends RadioSrf1BaseFeature
{
    ...
    public function init(RadioSrf1Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RadioSrf1Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
