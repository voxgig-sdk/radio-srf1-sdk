...
// RadioSrf1 SDK ratelimit feature
...
class RadioSrf1RatelimitFeature extends RadioSrf1BaseFeature
{
    ...
    private function _acquire(RadioSrf1Context $ctx): void
    {
    ...
    private function _track(RadioSrf1Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
