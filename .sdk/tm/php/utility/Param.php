...
// RadioSrf1 SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class RadioSrf1Param
{
    public static function call(RadioSrf1Context $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = RadioSrf1Helpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
