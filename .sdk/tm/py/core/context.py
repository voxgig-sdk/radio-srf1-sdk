...
from core.control import RadioSrf1Control
...
class RadioSrf1Context:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, RadioSrf1Spec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, RadioSrf1Result):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, RadioSrf1Response):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return RadioSrf1Error(code, msg, self)
