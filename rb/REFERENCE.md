# RadioSrf1 Ruby SDK Reference

Complete API reference for the RadioSrf1 Ruby SDK.
...
```ruby
require_relative 'radio-srf1_sdk'
...
#### `RadioSrf1SDK.test(testopts = nil, sdkopts = nil)`
