...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.RADIOSRF1_TEST_LIVE ||
    'TRUE' === process.env.RADIOSRF1_TEST_OVERRIDE
  ) {
  ...
  m.RADIOSRF1_TEST_EXPLAIN = process.env.RADIOSRF1_TEST_EXPLAIN || m.RADIOSRF1_TEST_EXPLAIN
