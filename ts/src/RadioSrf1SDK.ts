...
class RadioSrf1SDK {
  ...
  static test(testoptsarg?: any, sdkoptsarg?: any) {
    ...
    const testsdk = new RadioSrf1SDK(sdkopts)
    testsdk._mode = 'test'
  ...
  tester(testopts?: any, sdkopts?: any) {
    return RadioSrf1SDK.test(testopts, sdkopts)
  }


  toJSON() {
    return { name: 'RadioSrf1' }
  }

  toString() {
    return 'RadioSrf1 ' + this._utility.struct.jsonify(this.toJSON())
  }
